...
Na pratica esses venvs vao se acumulando. Pior ainda quando uma pasta de projeto esta dentro de um servico de sincronizacao (Google Drive, Dropbox, Insync): o venv inteiro sobe para a nuvem sem necessidade, ocupando gigabytes e, muitas vezes, chegando quebrado do outro lado.
