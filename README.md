...
Na pratica esses venvs vao se acumulando pelo disco. E as coisas pioram quando um projeto acaba indo parar num backup: o venv inteiro vai junto, sem necessidade, ocupa gigabytes e costuma chegar quebrado do outro lado (com o Python apontando para caminhos que nao existem mais).
